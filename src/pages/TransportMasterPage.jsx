              ...
              <div>
                {!isAdd && (
                  <button
                    type="button"
                    onClick={async () => {
                      if (window.confirm(`Are you sure you want to delete transporter "${transporter?.transporterName || ''}"? This action cannot be undone.`)) {
                        const success = await deleteTransporterMaster(transporter.id);
                        if (success) onBack();
                      }
                    }}
            ...
            <Table>
              <Table.ScrollContainer>
                ...
                >
                  ...
                  <Table.Body items={pagedTransporters} loadingState={isLoading ? 'loading' : 'idle'} loadingContent={<Spinner size="lg" color="primary" />} renderEmptyState={() => (
                    isLoading ? null : (
