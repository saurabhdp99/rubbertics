...
function mapFromDb(row) {
  return {
    ...
    customerVendorCode: row.customer_vendor_code || '',
...
function mapToDb(data, orgId, userId) {
  const payload = {
    ...
    bill_to_address_line1: data.addressLine1,
    bill_to_address_line2: data.addressLine2,
    bill_to_city: data.city,
    bill_to_district: data.district,
    bill_to_state: data.state,
    bill_to_pin_code: data.pinCode,
    bill_to_country: data.country,
    ship_to_address_line1: data.shipToAddressLine1,
    ship_to_address_line2: data.shipToAddressLine2,
    ship_to_city: data.shipToCity,
    ship_to_district: data.shipToDistrict,
