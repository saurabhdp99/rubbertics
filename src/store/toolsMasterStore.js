...
function mapFromDb(row) {
  ...
  return {
    ...
    itemNetWeight: row.item_net_weight != null ? Number(row.item_net_weight) : '',
    sortWeight: row.sort_weight != null ? Number(row.sort_weight) : '',
...
function mapToDb(data, orgId, userId) {
  const payload = {
    ...
    item_net_weight: data.itemNetWeight !== '' && data.itemNetWeight != null ? Number(data.itemNetWeight) : null,
    sort_weight: data.sortWeight !== '' && data.sortWeight != null ? Number(data.sortWeight) : null,
