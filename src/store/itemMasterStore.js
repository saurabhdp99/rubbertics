...
function mapFromDb(row) {
  return {
    ...
    itemStdWeightUom: row.item_std_weight_uom || '',
    itemNetWeight: Number(row.item_net_weight || 0),
    itemNetWeightUom: row.item_net_weight_uom || '',
    ...
    standardPackingUom: row.standard_packing_uom || '',
...
function mapToDb(data, orgId, userId) {
  const payload = {
    ...
    item_std_weight_uom: data.itemStdWeightUom,
    item_net_weight: Number(data.itemNetWeight || 0),
    item_net_weight_uom: data.itemNetWeightUom,
    ...
    standard_packing_uom: data.standardPackingUom,
