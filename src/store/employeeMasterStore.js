...
function mapFromDb(row) {
  return {
    ...
    currentAddressLine2: row.current_address_line2,
    ...
    permanentAddressLine1: row.permanent_address_line1,
    permanentAddressLine2: row.permanent_address_line2,
...
function mapToDb(data, orgId, userId) {
  const payload = {
    ...
    current_address_line2: data.currentAddressLine2,
    current_city: data.currentCity,
    current_district: data.currentDistrict,
    current_state: data.currentState,
    current_pincode: data.currentPincode,
    current_country: data.currentCountry || 'India',
    same_as_current_address: data.sameAsCurrentAddress !== undefined ? data.sameAsCurrentAddress : true,
    permanent_address_line1: data.permanentAddressLine1,
    permanent_address_line2: data.permanentAddressLine2,
